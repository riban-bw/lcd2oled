/*
 ...
 This sketch prints "Hello World!" to the OLED then rotates through each orientation.
...
void loop() {
	delay(1000);
	lcd.Rotate(OLED_ROTATE_90);
	delay(1000);
	lcd.Rotate(OLED_ROTATE_180);
	delay(1000);
	lcd.Rotate(OLED_ROTATE_270);
	delay(1000);
	lcd.Rotate(OLED_ROTATE_0);
}
